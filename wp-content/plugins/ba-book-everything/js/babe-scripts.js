    ...
    function init_search_form_daterangepicker(is_single) {
        ...
        $('#date_from.search_date').daterangepicker({
            ...
            locale: {
                ...
                "daysOfWeek": Object.keys(babe_lst.daterangepickerLocale.daysOfWeek).map(function(key) {
                    return babe_lst.daterangepickerLocale.daysOfWeek[key];
                }),
                "monthNames": Object.keys(babe_lst.daterangepickerLocale.monthNames).map(function(key) {
                    return babe_lst.daterangepickerLocale.monthNames[key];
                }),
